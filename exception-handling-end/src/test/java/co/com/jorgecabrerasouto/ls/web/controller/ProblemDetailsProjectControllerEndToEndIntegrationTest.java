...
import co.com.jorgecabrerasouto.alternativecontextconfig.web.errors.ProblemDetailsGlobalExceptionHandler;
import co.com.jorgecabrerasouto.ls.LsApp;
import co.com.jorgecabrerasouto.ls.persistence.model.Project;

@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@ContextConfiguration(classes = { LsApp.class, ProblemDetailsGlobalExceptionHandler.class })
public class ProblemDetailsProjectControllerEndToEndIntegrationTest {
    ...
    public void whenGetNonExistingProject_thenGetEntityRetrieves4xxWithBootErrorFields() throws Exception {
        ...
        ResponseEntity<ProblemDetail> errorResponse = this.restTemplate.exchange(request, ProblemDetail.class);

        assertThat(errorResponse.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
        assertThat(errorResponse.getBody()
            .getDetail()).isEqualTo("Project not found");
    }
